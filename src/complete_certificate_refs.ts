...
export class CompleteCertificateRefs extends XmlXadesObject {
    ...
    protected name = XmlXades.ElementNames.CompleteCertificateRefs;
    ...
    public LoadXml(element: Element): void {
        ...
        let xmlCertRefs = this.GetElement(XmlXades.ElementNames.CertRefs, false);
        if (xmlCertRefs) {
            this.CertRefs = new CertRefs();
