...
export class Identifier extends XmlXadesObject {
    ...
    protected name = XmlXades.ElementNames.Identifier;
    ...
    public LoadXml(element: Element): void {
        ...
        this.Qualifier = (KnownQualifier as any)[+this.GetAttribute(XmlXades.AttributeNames.Qualifier, KnownQualifier.Uninitalized.toString(), false) !];
