...
import { OtherCertificate, OtherCertificateCollection } from "./other_certificate";
import { EncapsulatedX509Certificate, EncapsulatedX509CertificateCollection } from "./encapsulated_x509";
...
export class CertificateValues extends XmlXadesObject {
    ...
    protected name = XmlXades.ElementNames.CertificateValues;
    ...
    public LoadXml(element: Element): void {
        ...
        let xmlNodeList = this.GetChildren(XmlXades.ElementNames.EncapsulatedX509Certificate);
        ...
        xmlNodeList = this.GetChildren(XmlXades.ElementNames.OtherCertificate);
        for (let xmlNode of xmlNodeList) {
            let newOtherCertificate = new OtherCertificate();
            newOtherCertificate.LoadXml(xmlNode);
