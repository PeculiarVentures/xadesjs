    ...
    */
    export class QualifyingProperties extends XmlXadesObject {
        ...
        protected GetXmlObjectName() {
            return XmlXades.ElementNames.QualifyingProperties;
        }
        ...
        public LoadXml(element: Element, counterSignedXmlElement?: Element) {
            ...
            this.target = this.getAttribute(element, XmlXades.AttributeNames.Target, "", true);

            // TODO: Code does not match the schema
            this.signedProperties = new SignedProperties();
            this.signedProperties.LoadXml(this.GetElement(element, XmlXades.ElementNames.SignedProperties, true));

            let xmlUnsignedProperties = this.GetElement(element, XmlXades.ElementNames.UnsignedProperties, false);
		...
		*/
        public GetXml(): Element {
            ...
            if (this.target) {
                ...
                throw new XmlError(XE.CRYPTOGRAPHIC, "QualifyingProperties Target attribute has no value");
            }
