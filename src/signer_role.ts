...
import { ClaimedRoles } from "./claimed_role";
import { CertifiedRoles } from "./certified_role";
...
export class SignerRole extends XmlXadesObject {
    ...
    protected name = XmlXades.ElementNames.SignerRole;
    ...
    public LoadXml(element: Element): void {
        ...
        let xmlClaimedRoles = this.GetElement(XmlXades.ElementNames.ClaimedRoles, false);
        if (xmlClaimedRoles) {
            this.ClaimedRoles = new ClaimedRoles();
            this.ClaimedRoles.LoadXml(xmlClaimedRoles);
        }

        let xmlCertifiedRoles = this.GetElement(XmlXades.ElementNames.CertifiedRoles, false);
