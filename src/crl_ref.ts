namespace xadesjs.pro {
    ...
    export class CRLRef extends XmlXadesObject {
        ...
        public LoadXml(element: Element): void {
            ...
            let xmlDigestAlgAndValue = this.GetElement(element, XmlXades.ElementNames.DigestAlgAndValue, true);
            ...
            let xmlCRLIdentifier = this.GetElement(element, XmlXades.ElementNames.CRLIdentifier, false);
            if (!xmlCRLIdentifier) {
        ...
        public GetXml(): Element {
            ...
            if (this.digestAlgAndValue && this.digestAlgAndValue.HasChanged()) {
                ...
                throw new XmlError(XE.CRYPTOGRAPHIC, "DigestAlgAndValue element missing in CRLRef");
            }
