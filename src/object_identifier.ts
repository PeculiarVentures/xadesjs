namespace xadesjs.pro {
    ...
    export class ObjectIdentifier extends XmlXadesTaggedObject {
        ...
        public LoadXml(element: Element): void {
            ...
            let xmlIdentifier = this.GetElement(element, XmlXades.ElementNames.Identifier);
            this.Identifier = new Identifier();
            ...
            let xmlDocumentationReferences = this.GetElement(element, XmlXades.ElementNames.DocumentationReferences, false);
        ...
        public GetXml(): Element {
            ...
            if (this.Identifier && this.Identifier.HasChanged()) {
                ...
                throw new XmlError(XE.CRYPTOGRAPHIC, "Identifier element missing in OjectIdentifier");
            }
