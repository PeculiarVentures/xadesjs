...
export class NoticeNumbers extends XmlJs.Collection<number> { }
...
export class NoticeRef extends XmlXadesObject {
    ...
    protected name = XmlXades.ElementNames.NoticeRef;
    ...
    public LoadXml(element: Element): void {
        ...
        this.Organization = this.GetElement(XmlXades.ElementNames.Organization, true).textContent!;
        let xmlNoticeNumber = this.GetElement(XmlXades.ElementNames.NoticeNumbers, true)!;
        this.NoticeNumbers = new NoticeNumbers();
        let xmlNodeList = XmlXadesObject.GetChildren(xmlNoticeNumber, XmlXades.ElementNames.Int, XmlXades.NamespaceURI);
    ...
    public GetXml(): Element {
        ...
        if (this.Organization == null) {
            throw new XmlJs.XmlError(XmlJs.XE.CRYPTOGRAPHIC, "Organization can't be null");
        }
        ...
        if (this.NoticeNumbers == null) {
            throw new XmlJs.XmlError(XmlJs.XE.CRYPTOGRAPHIC, "NoticeNumbers can't be null");
        }
