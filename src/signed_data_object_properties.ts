namespace xadesjs.pro {
    ...
    export class SignedDataObjectProperties extends XmlXadesObject {
        ...
        protected GetXmlObjectName() {
            return XmlXades.ElementNames.SignedDataObjectProperties;
        }

        protected GetItemsFromElement(element: Element, itemElementName: string, itemCollection: Collection<any>, ItemClass: any, tagName?: string): void {
        ...
        protected GetXmlFromCollection(element: Element, collection: Collection<XmlXadesObject>) {
