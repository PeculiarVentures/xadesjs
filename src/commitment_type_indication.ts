namespace xadesjs.pro {
    ...
    export class CommitmentTypeIndicationCollection extends Collection<CommitmentTypeIndication> { }
    ...
    export class CommitmentTypeIndication extends XmlXadesObject {
        ...
        protected GetXmlObjectName() {
            return XmlXades.ElementNames.CommitmentTypeIndication;
        }
        ...
        public LoadXml(element: Element): void {
            let xmlCommitmentTypeId = this.GetElement(element, XmlXades.ElementNames.CommitmentTypeId);
            this.CommitmentTypeId = new ObjectIdentifier(XmlXades.ElementNames.CommitmentTypeId);
            this.CommitmentTypeId.LoadXml(xmlCommitmentTypeId);

            let xmlNodeList = element.getElementsByTagNameNS(XmlXades.NamespaceURI, XmlXades.ElementNames.ObjectReference);
            ...
            let xmlCommitmentTypeQualifiers = this.GetElement(element, XmlXades.ElementNames.CommitmentTypeQualifiers, false);
        ...
        public GetXml(): Element {
            ...
            if (this.CommitmentTypeId && this.CommitmentTypeId.HasChanged()) {
                ...
                throw new XmlError(XE.CRYPTOGRAPHIC, "CommitmentTypeId element missing");
            }
