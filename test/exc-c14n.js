...
describe("Exclusive canonicalization with comments", function() {
    ...
    it("Exclusive canonicalization works on xml with no namespaces", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on inner xpath", function(done) {
        compare(
            "<root><child>123</child></root>",
            "//*[local-name(.)='child']",
            "<child>123</child>",
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined in output nodes", function(done) {
        compare(
    ...
    it("element used prefixed ns which is also the default", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined in output nodes. ns definition is not duplicated on each usage", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined in output nodes but before used", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespaces defined outside output nodes", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespace defined in inclusive list", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with multiple prefixed namespaces defined in inclusive list", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespace defined in inclusive list defined outside output nodes", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with prefixed namespace defined in inclusive list used on attribute", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with default namespace inside output nodes", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with multiple different default namespaces", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with multiple similar default namespaces", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with default namespace outside output nodes", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works when prefixed namespace is defined in output nodes not in the parent chain of who needs it", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with unordered attributes", function(done) {
        compare(
    ...
    it("Exclusive canonicalization sorts upper case attributes before lower case", function(done) {
        compare(
            "<x id=\"\" Id=\"\"></x>",
            "//*[local-name(.)='x']",
            "<x Id=\"\" id=\"\"></x>",
    ...
    it("Exclusive canonicalization with comments retains comments", function(done) {
        compare(
            "<x id=\"\" Id=\"\"><!-- Comment --></x>",
            "//*[local-name(.)='x']",
            "<x Id=\"\" id=\"\"><!-- Comment --></x>",
    ...
    it("Exclusive canonicalization works on xml with attributes with different namespace than element", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on xml with attribute and element values with special characters", function(done) {
        compare(
    ...
    it("Exclusive canonicalization preserves white space in values", function(done) {
        compare(
            "<root><child><inner>12\n3\t</inner></child></root>",
            "//*[local-name(.)='child']",
            "<child><inner>12\n3\t</inner></child>",
    ...
    it("Exclusive canonicalization preserves white space bewteen elements", function(done) {
        compare(
    ...
    it("Exclusive canonicalization turns empty element to start-end tag pairs", function(done) {
        compare(
    ...
    it("Exclusive canonicalization preserves empty start-end tag pairs", function(done) {
        compare(
    ...
    it("Exclusive canonicalization with empty default namespace outside output nodes", function(done) {
        compare(
    ...
    */
    ...
    it("Exclusive canonicalization with empty default namespace inside output nodes", function(done) {
        compare(
    ...
    it("The XML declaration and document type declaration (DTD) are removed", function(done) {
        compare(
    ...
    */
    ...
    it("Attribute value delimiters are set to quotation marks (double quotes)", function(done) {
        compare(
    ...
    it("CDATA sections are replaced with their character content", function(done) {
        compare(
    ...
    it("SignedInfo canonization", function(done) {
        compare(
    ...
    it("Exclusive canonicalization works on complex xml", function(done) {
        compare(
    ...
    /*
      ...
      */
    it("Lexicographic comparison, which orders strings from least to greatest alphabetically, is based on the UCS codepoint values, which is equivalent to lexicographic ordering based on UTF- 8.", function(done) {
        compare(
    ...
    it("saml attributed order (bug #25)", function(done) {
        compare(
